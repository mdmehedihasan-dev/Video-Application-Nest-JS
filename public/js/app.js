var AppProcess = (function () {
  ...
  function eventProcess() {
    ...
    $("#miceMuteUnmute").on("click", async function () {
      ...
      if (isAudioMute) {
        console.log("Audio mutd: "+isAudioMute)
        audio.enabled = true;
        $(this).html(
  ...
  async function updateMediaSenders(track, rtp_senders) {
    console.log("Peers id: "+peers_connection_ids)
  ...
  async function SDPProcess(message, from_connid) {
    ...
    if (message.answer) {
      ...
      let vdo = document.querySelector("#v_" + from_connid + "");
      vdo.srcObject = null
    }
  }
  ...
  function addUser(other_user_id, connId, userNum) {
    ...
    $(".in-call-wrap-up").append(
      '<div class="in-call-wrap d-flex justify-content-between align-items-center mb-3" id="participant_' +
        connId +
        '"> <div class="participant-img-name-wrap display-center cursor-pointer"> <div class="participant-img"> <img src="images/other.jpg" alt="" class="border border-secondary" style="height: 40px;width: 40px;border-radius: 50%;"> </div> <div class="participant-name ml-2"> ' +
        other_user_id +
